                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <ul class="tab-btns tab-buttons clearfix">
                            <li data-tab="#prod-about" class="tab-btn"><span>About Company</span></li>
                            <li data-tab="#prod-market" class="tab-btn active-btn"><span>General Questions</span></li>
                            <li data-tab="#prod-estimate" class="tab-btn"><span>Market Sizing / Estimates</span></li>
                            <li data-tab="#prod-case" class="tab-btn"><span>Case Questions</span></li>
                            <li data-tab="#prod-knowledge" class="tab-btn"><span>Random Knowledge</span></li>
                        </ul>
                    </div>
                    <!--Column-->
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="tabs-content">
                                ...
                                <div class="content">
                                    ...
                                    <ul class="accordion-box">
                                        ...
                                        <li class="accordion block">
                                            <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Do you give any offer for premium customer?</div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <!--Block-->
                                        <li class="accordion block">
                                            <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Why Would a Successful Entrepreneur Hire a Coach?</div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                                </div>
                                        ...
                                        <li class="accordion block active-block">
                                            <div class="acc-btn active"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>What is the procedure to join with your company?</div>
                                        ...
                                        <!--Block-->
                                        <li class="accordion block">
                                            <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Waht makes your financial projects special?</div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                                </div>
                                        ...
                                        <!--Block-->
                                        <li class="accordion block">
                                            <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Can I offer my items for free on a promotional basis?</div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                                </div>
                                        ...
                                        <!--Block-->
                                        <li class="accordion block">
                                            <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Is there a limit to the number of guests should plan in a day?</div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                                </div>
                            ...
                            <!--Tab -->
                            <div class="tab" id="prod-estimate">
                                <div class="content">
                                    <ul class="accordion-box">
                            ...
                            <!--Tab -->
                            <div class="tab" id="prod-knowledge">
                                <div class="content">
...
<!--Google Map APi Key-->
<script src="../../maps/api/js-1?key=AIzaSyBKS14AnP3HCIVlUpPKtGp7CbYuMtcXE2o"></script>
